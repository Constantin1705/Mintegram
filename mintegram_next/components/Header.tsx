...
export default function Header() {
  ...
  const { formattedTime, isRecovering, maxHearts, progress } = useHeartTimer();
      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            {/* Economy quick status - only show when logged in */}
            {user && (
              <div className="hidden md:flex items-center gap-3 px-3 py-2 rounded-xl bg-gray-50 border border-gray-200">
                <div className="flex flex-col items-center gap-1">
                  <div className="flex items-center gap-1">
                    ...
                    <span className="font-semibold text-gray-800">{hearts}/{maxHearts}</span>
                  </div>
                  {isRecovering && (
        ...
        {isMobileMenuOpen && (
          ...
          >
            <nav className="flex flex-col gap-2">
              ...
              {/* Mobile economy status - only show when logged in */}
              {user && (
                <div className="flex flex-col gap-3 px-4 py-3 rounded-xl bg-gray-50 border border-gray-200">
                  <div className="flex items-center gap-3">
                    ...
                    <Link href="/subscriptions" className="inline-flex items-center gap-1 px-2 py-1 rounded-lg bg-linear-to-r from-purple-100 to-pink-100 text-purple-700">
                      <Crown size={14} />
                      <span className="text-xs font-semibold">Pro</span>
                    </Link>
                  </div>
